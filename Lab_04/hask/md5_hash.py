    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            if j < 16:
                ...
                f = (d & b) | ((~d) & c)
                g = (5*j + 1) % 16
            # Đảm bảo các dòng dưới đây được thụt lề đúng (thụt vào 4 khoảng trắng so với elif)
            elif j < 48:
                f = b ^ c ^ d
                g = (3*j + 5) % 16
            else:
            ...
            d = c
            c = b
            # Chú ý: Dòng này vẫn có thể có lỗi về hằng số và số lượng xoay (đã đề cập trước đó)
