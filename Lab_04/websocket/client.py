...
class WebSocketClient:
    ...
    # This method needs to be de-indented to be part of the WebSocketClient class
    ...
    # This method also needs to be de-indented to be part of the WebSocketClient class
